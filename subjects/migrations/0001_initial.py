    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period_season', models.CharField(choices=[('O', 'Otoño'), ('P', 'Primavera')], default='O', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            options={'ordering': ('period_year', 'period_season', 'phase')},
        ),
        migrations.AddConstraint(
            model_name='periodphaseschedule',
            constraint=models.UniqueConstraint(fields=('period_year', 'period_season', 'phase'), name='uniq_period_phase_schedule'),
        ),
        migrations.AddConstraint(
            model_name='subject',
            constraint=models.UniqueConstraint(fields=('code', 'section', 'period_year', 'period_season'), name='uniq_subject_code_section_period'),
        ),
        migrations.CreateModel(
            name='SubjectUnit',
            fields=[
